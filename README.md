...
## Forked due to some minor changes we needed
...
3. Enter `https://github.com/ConatusCo/UnityGraphicsCapture.git?path=/UnityGraphicsCapture/Packages/io.github.ruccho.graphicscapture`
